  ...
  <table border="1" style="border-collapse: collapse; width: 100%; text-align: left;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="padding: 8px; border: 1px solid #ddd;">Dirección asignada al dispositivo encargado de transmitir información de otras redes</td>
...
<table>
  <tr>
    ...
    <td>El protocolo ARP permite a los dispositivos asociar su dirección MAC con una dirección IP en la red. Si un dispositivo desea comunicarse con otro, envía una transmisión a toda la red para buscar la dirección MAC del dispositivo de destino.<br>
