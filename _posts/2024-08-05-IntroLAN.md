...
<div class="image-container" style="text-align: center;">
  <img src="../assets/images/Labs/LAN/Untitled 3.png" alt="Ejemplo de redes LAN conectadas;" style="width: 100%; max-width:500px" class="thumbnail" onclick="openModal(this.src)">
</div>
